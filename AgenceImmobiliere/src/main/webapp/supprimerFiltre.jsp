			...
			<h:form>
				<h:panelGrid columns="1">
					...
					<rich:scrollableDataTable id="annonceTable"
						binding="#{filtreBean.filtreTableSup}"
						value="#{filtreBean.filtreListSup}" var="item" width="500px"
						height="200px">
						<!--  a4j:support et onRowObClick c pour le double clique -->
						<a4j:support event="onRowDblClick"
							action="#{filtreBean.viewDetailSuuprimerFiltre}" />
					...
					<h:panelGroup>
						<h:commandButton value="Delete Filtre"
							action="#{filtreBean.viewDetailSuuprimerFiltre }"></h:commandButton>
